	...
	return (
		<section id='experience' className='py-20 px-4'>
			<div className='max-w-4xl mx-auto'>
				<h2 className='text-4xl md:text-5xl font-bold mb-12 bg-linear-to-r from-primary to-accent bg-clip-text text-transparent text-center'>{t('experience.title')}</h2>

				<div className='space-y-8'>
					{experiences.map((exp, idx) => (
						<div key={idx} className='bg-white/70 dark:bg-zinc-800/70 backdrop-blur-md rounded-2xl p-8 border-l-4 border-primary dark:border-primary-dark shadow-xl hover:scale-[1.02] transition-transform'>
							<div className='flex items-start gap-4'>
								...
								<div className='flex-1'>
									<div className='flex flex-col md:flex-row md:items-start md:justify-between mb-4'>
										<div>
											<h3 className='text-2xl font-bold text-primary dark:text-primary-dark mb-2'>{exp.title}</h3>
